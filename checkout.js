...
function validation() {
  ...
  for (var i = 0; i < submit_form.length; i++) {
    if (submit_form[i] == false) return false;
  }
  return true;
}
function email_validation() {
  ...
  if (email.match(email_pattern)) {
    document
      ...
      .setAttribute("style", "border:1px green solid ");
    submit_form[0] = true;
  } else {
    document
      .getElementById("checkout-email")
      .setAttribute("style", "border:1px red solid ");
    submit_form[0] = false;
  }
}
function name_surname_adress_city_validation() {
  ...
  if (surname.match(name_pattern)) {
    document
      .getElementById("chekout-surname")
      .setAttribute("style", "border:1px green solid ");
    is_valid[1] = true;
  } else {
    document
      .getElementById("checkout-surname")
      .setAttribute("style", "border:1px red solid ");
    is_valid[1] = false;
  }
