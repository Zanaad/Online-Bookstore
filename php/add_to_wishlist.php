...
// Fetch book details
$query = $conn->prepare("SELECT title, price, image, author FROM books WHERE id = ?");
...
if ($book) {
 ...
 $insert_query = $conn->prepare("INSERT INTO wishlist (user_id, book_id, name, author, price, quantity, image) VALUES (?, ?, ?, ?, ?, ?, ?)");
